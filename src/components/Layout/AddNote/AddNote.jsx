...
function AddNote() {
  ...
  useEffect(() => {
    if (isImageChooseOpen) {
      document.body.style.background = 'rgba(50, 47, 40, 0.70)';
    ...
    <>
      {isImageChooseOpen ? (
        <div className={styles.chooseWrapper}>
          ...
          <ImagesList notes={notes} imgHeight={'271'} gap={'40'} />
        </div>
      ) : (
            ...
            <div className={styles.leftBlock}>
              <div className={styles.upperInner}>
                <div className={styles.inputBlock}>
                  <Input className={styles.inputText} type='text' placeholder='Название' />
                  <div className={styles.flexBlock}>
                    <Selector />
                    <Input className={styles.inputDate} type='date' placeholder='Дата' />
                  </div>
                </div>
                <div className={styles.imageChoose} onClick={toggleChooseOpen}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='20'
                    height='16'
              ...
              <Textarea className={styles.textareaMain} />
              <Button
